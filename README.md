...
### Example-1:
![hover_magnifier demo](https://github.com/Cisco0xf/hover_magnifier/blob/main/example/assets/gif/mgnifier_1.gif)
```dart
Container(
...
```
![hover_magnifier demo](https://github.com/Cisco0xf/hover_magnifier/blob/main/example/assets/gif/magnifier_3.gif)

---------
### Example-2:
![hover_magnifier demo](https://github.com/Cisco0xf/hover_magnifier/blob/main/example/assets/gif/magnifier_4.gif)
```dart
Container(
  padding: const EdgeInsets.all(10.0),
  width: screenWidth * .5,
...
---------
### Example-3:
![hover_magnifier demo](https://github.com/Cisco0xf/hover_magnifier/blob/main/example/assets/gif/magnifier_5.gif)
```dart
SizedBox(
...
---------
### Example-4:
![hover_magnifier demo](https://github.com/Cisco0xf/hover_magnifier/blob/main/example/assets/gif/magnifier_2.gif)
```dart
Container(
  decoration: BoxDecoration(
    borderRadius: borderRadius(10.0, false),
